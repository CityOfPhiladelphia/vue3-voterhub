...
const $config = {
  topicStyles: {
    ...
    'Elections-and-Ballots': 'votingDrawnMapStyle',
    'Polling-Place': 'votingDrawnMapStyle',
    'Mail-in-Voting': 'votingDrawnMapStyle',
    'Elected-Officials': 'votingDrawnMapStyle',
  ...
  parcelLayerForTopic: {
    ...
    Condominiums: 'pwd',
    Deeds: 'dor',
    'Elections-and-Ballots': 'pwd',
    'Polling-Place': 'pwd',
    'Mail-in-Voting:': 'pwd',
    'Elected-Officials:': 'pwd',
    'Nearby Activity': 'pwd',
    Districts: 'pwd',
  },
  mapLayers: {
